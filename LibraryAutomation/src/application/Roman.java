...
public class Roman extends Kitap {
    ...
    public Roman(int barkod, String ad, int sayfa, int baskiyili, String dil, String yayinevi, String yazar, String detay, String aciklama, String rafno, String bolum) {
