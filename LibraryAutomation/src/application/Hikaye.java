...
public class Hikaye extends Kitap {
    ...
    public Hikaye(int barkod, String ad, int sayfa, int baskiyili, String dil, String yayinevi, String yazar, String detay, String aciklama, String rafno, String bolum) {
